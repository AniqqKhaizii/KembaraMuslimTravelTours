...
import KembaraDuaTanahSuci from "@/app/_components/KembaraDuaTanahSuci";
	...
	return (
		<div className="w-full h-full bg-gray-50">
			<div className="grid grid-cols-1 gap-12 max-w-screen-xl mx-auto py-12 px-6">
				...
				<section className="my-16">
					{categories.map((category, index) => (
						<div key={index} className="mb-10">
							<h3 className="text-2xl font-medium text-gray-800 mb-5 capitalize">
								{category.name}
							</h3>
				...
				{/* Umrah Tips Section */}
				<section>
					<h2 className="text-4xl text-orange-600 font-bold mb-8 text-center">
