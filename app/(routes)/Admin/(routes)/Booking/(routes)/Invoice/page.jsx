			...
			{bookData && (
				...
				>
					...
					<div className="absolute bottom-0 left-0 right-0">
						<hr className="col-span-4 w-full h-6 bg-gradient-to-r from-orange-600 via-orange-400 to-orange-500 mb-1" />
						<div className="max-w-screen-xl mx-auto  flex items-center justify-center py-4 bg-gradient-to-r from-orange-600 via-orange-400 to-orange-400">
