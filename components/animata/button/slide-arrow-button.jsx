...
export default function SlideArrowButton({
	...
	return (
		<button
			className={`group relative rounded-2xl w-full border border-white bg-orange-600 px-2 py-2  ${className}`}
			{...props}
		>
			<div
				className="absolute left-0 top-0 flex h-full w-10 border border-white items-center justify-end rounded-2xl transition-all duration-400 ease-in-out group-hover:w-full"
