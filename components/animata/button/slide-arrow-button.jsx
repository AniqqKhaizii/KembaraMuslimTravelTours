...
export default function SlideArrowButton({
	...
	return (
		<button
			className={`group relative rounded-full border border-white bg-orange-600 px-2 py-3  ${className}`}
			{...props}
		>
			<div
				className="absolute left-0 top-0 flex h-full w-11 items-center justify-end rounded-full transition-all duration-400 ease-in-out group-hover:w-full"
